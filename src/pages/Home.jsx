...
// 🖼️ Import Assets
import photo from '../../public/./Me/Shakil.jpeg'
...
export default function Home() {
  ...
  const quickLinks = [
    { img: githubLogo, title: 'GitHub', link: 'https://github.com/rakibulhasanshakil' },
    { img: linkedinLogo, title: 'LinkedIn', link: 'https://www.linkedin.com/in/rakibul-hasan-shakil/' },
    { img: gmailLogo, title: 'Email', link: 'mailto:hasanshakilr@gmail.com' },
      ...
      <div className="home-top">
        ...
        >
          ...
          <p className="typing-effect">
            Full-Stack Machine Larning Engineer | Researcher | Data Analyst
            </p>
          ...
          <motion.div className="info-cards">
            {[
              { label: '📍 Location', value: 'Bashundhara RA, Dhaka, Bangladesh' },
              { label: '💼 Expertise', value: 'Machine Learning, Data Analysis' },
              { label: '📧 Contact', value: 'hasanshakilr@gmail.com' },
            ].map((info, i) => (
